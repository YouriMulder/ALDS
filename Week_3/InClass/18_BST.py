...
class BST:
	...
	def isBalanced(self, distances, currentDistance = 0, currentNode = None):
		currentDistance += 1
		...
		if currentNode.left is None or currentNode.right is None:
			if currentNode is self.root:
				return False
			distances[currentDistance] = "End"
			return
				
		self.isBalanced(distances, currentDistance, currentNode.left)
		self.isBalanced(distances, currentDistance, currentNode.right)

		return len(distances) == 1

if __name__ == '__main__':
	b = BST([1,2,3])
	print("Balanced", b.isBalanced({}))
